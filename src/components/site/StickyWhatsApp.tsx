...
export function StickyWhatsApp({ number, message }: Props) {
  ...
  return (
    <a
      ...
      className="fixed bottom-3 left-2 z-40 grid size-12 place-items-center rounded-full bg-accent text-accent-foreground shadow-xl wa-pulse md:bottom-4 md:left-3 md:size-14"
    >

...
export const ENTITIES: EntityConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "status", label: "الحالة", type: "select", options: [
        { value: "new", label: "جديد" }, { value: "in_review", label: "قيد المراجعة" },
        { value: "contacted", label: "تم التواصل" }, { value: "converted", label: "تم التحويل" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "staff_notes", label: "ملاحظات داخلية", type: "textarea" },
    ],
  },
  {
    ...
    listColumns: [
      ...
      { key: "contact_email", label: "البريد", type: "text" },
      { key: "country", label: "الدولة", type: "text" },
      { key: "status", label: "الحالة", type: "status" },
      { key: "created_at", label: "التاريخ", type: "date" },
    ],
    searchColumns: ["company_name", "contact_name", "contact_email"],
    labelColumn: "company_name",
    orderBy: { column: "created_at", ascending: false },
    fields: [
      { key: "company_name", label: "اسم الشركة", type: "text", required: true },
      { key: "contact_name", label: "اسم المسؤول", type: "text", required: true },
      { key: "contact_email", label: "البريد", type: "text", required: true },
      { key: "contact_phone", label: "الهاتف", type: "text" },
